...
<html lang="en">
    <head>
        ...
        <title>LD Gate PHP Summary</title>
        ...
        <div id="page-container">
            ...
            <div class="page-wrap">
                ...
                <div id="breadcrumbs">
						...
						<div id="topPane" class="col-md backend-cp-collapsible">
							<div class="box-usace">
								<h2 class="box-header-striped">
									<span class="titleLabel title">LD Gate Summary PHP V2.0</span>
									<span class="rss"></span>
								</h2>
								<div class="box-content" style="background-color:white;margin:auto">
									<div class="content">
                                        ...
                                        <span><h3><a href='ld_gate_summary.html?cda=internal'>Switch to CDA Internal</a></h3></span>
                                        <span><h3><a href='ld_gate_summary.html?cda=public'>Switch to CDA Public</a></h3></span>
                                        <div class="alert">
                                        <strong>May 2024 - Version V2.0</strong> - This report was build using PHP, JSON, CWMS and JavaScript, no coldfusion schema was used<br>
                                    </div>
									</div>
								</div>
							</div>
                    ...
                    <div id="loading_ld_gate_summary" style="display: none;"><img src="../../../images/gif/loading4.gif" style='height: 50px; width: 50px;' alt="Loading..." /></div>
                    <div id="table_container_ld_gate_summary"></div>
                    <script src="ld_gate_summary2.js"></script>
                    <!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    <div class="page-content">
                        <sidebar id="sidebar">
